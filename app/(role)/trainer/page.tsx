...
const DistrictOfficerDetails = ({
  ...
  <div className="space-y-4">
    <DetailItem
      ...
      formData={{
        ...data,
        assignedSchools: data.assignedSchools.join(", ")
      } as any}
      onChange={onChange}
    />
    <DetailItem
...
export default function UserRolePage() {
  ...
  const roleParam = (params.role as string)?.toLowerCase().trim();
    ...
    const matchedUser = userData.find(
      (u) =>
        u.role
          ...
          .replace(/\s+/g, "-")
          .replace(/\//g, "-") ===
        roleParam.replace(/\s+/g, "-").replace(/\//g, "-")
    );
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prev) => {
      ...
      if (name === "assignedSchools") {
        return {
          ...prev,
          assignedSchools: value.split(",").map((s) => s.trim())
        };
      }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-6">
                {user.role.trim().toLowerCase() === "district" && (
                ...
                {user.role.trim().toLowerCase() === "head of school" && (
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <DetailItem
                  ...
                  label="Viewed school reports"
                  value="2023-06-20 14:30"
                  isEditing={false}
                  name=""
                  formData={null}
                  onChange={() => {}}
                ...
                <DetailItem
                  icon={<School size={16} />}
                  label="Updated student records"
                  value="2023-06-18 10:15"
                  isEditing={false}
                  name=""
                  formData={null}
                  onChange={() => {}}
                ...
                <DetailItem
                  icon={<User size={16} />}
                  label="Logged in to system"
                  value="2023-06-15 09:00"
                  isEditing={false}
                  name=""
                  formData={null}
                  onChange={() => {}}
